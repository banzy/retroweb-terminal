...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "RetroWeb" },
      { name: "description", content: "RetroWeb — a vintage computing experience" },
      { property: "og:title", content: "RetroWeb" },
      { property: "og:description", content: "RetroWeb — a vintage computing experience" },
